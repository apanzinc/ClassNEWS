...
from PySide6.QtCore import Qt, QTimer, QObject, Signal, Slot, Property, QThread, QEvent
...
class ConfigManager(QObject):
    ...
    def clearAllData(self):
        ...
        # 6. Force exit (prevents config from being recreated)
        os._exit(0)
...
class ProtocolManager(QObject):
    ...
    def __init__(self, video_manager=None, news_manager=None, parent=None):
        super().__init__(parent)
